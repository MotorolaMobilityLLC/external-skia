...
#include "include/mtk/SkTRegistry.h"
#include "include/private/SkNoncopyable.h"
#include "include/private/SkEncodedInfo.h"

#include "src/codec/SkColorTable.h"

using namespace android::skia;
...
protected:
    ...
    */
    ...
    bool cropBitmap(SkBitmap *dst, SkBitmap *src, int sampleSize,
                    ...
                    int srcX, int srcY, BRDAllocator* allocator);
...
protected:
    ...
    */
    bool allocPixelRef(SkBitmap*, SkColorTable*, BRDAllocator* allocator) const;
...
public:
    ...
    bool decodeSubset(SkBitmap* bm, BRDAllocator* allocator, const SkIRect& subset, SkColorType pref, int sampleSize, sk_sp<SkColorSpace> dstColorSpace);

protected:
    virtual bool onDecodeSubset(SkBitmap* bitmap, BRDAllocator* allocator, const SkIRect& rect, int sampleSize, sk_sp<SkColorSpace> dstColorSpace) {
        return false;
    }
