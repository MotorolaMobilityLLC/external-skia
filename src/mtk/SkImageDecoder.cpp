...
bool SkImageDecoder::allocPixelRef(SkBitmap* bitmap,
                                   SkColorTable* ctable, BRDAllocator* allocator) const {
    if(allocator)
...
bool SkImageDecoder::cropBitmap(SkBitmap *dst, SkBitmap *src, int sampleSize,
    ...
    SkCanvas canvas(*dst);
    canvas.drawImage(src->asImage(), (srcX - dstX) / sampleSize,
...
bool SkImageDecoder::decodeSubset(SkBitmap* bm, BRDAllocator* allocator, const SkIRect& rect, SkColorType pref,
